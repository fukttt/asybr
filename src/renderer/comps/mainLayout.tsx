...
const MainLayout: FunctionComponent<OptionalProps> = ({ children, title }) => {
  ...
  const navigation = [
    ...
    { name: 'Utils', href: '/team', current: false },
    { name: 'Settings', href: '/projects', current: false },
  ];
              ...
              <div className="flex justify-between items-center h-16">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <img
                      className="w-8"
                      src="https://1000merken.com/wp-content/uploads/2021/02/Discord-Logo.png"
                      alt="Workflow"
                    />
                  </div>
                ...
                <div className="flex -mr-2 md:hidden">
                  {/* Mobile menu button */}
                  <Disclosure.Button className="inline-flex justify-center items-center p-2 text-gray-400 bg-gray-800 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
      ...
      <main>
        <div className="py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="p-4 h-96 rounded-lg border-4 border-gray-200 border-dashed">
              {children}
            </div>
          </div>
          {/* /End replace */}
